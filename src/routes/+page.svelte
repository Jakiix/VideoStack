<script>
	...
	import Bluray from "$lib/images/bluray_case.png"
...
<div 
	...
	<div class="card__translater">
		<div
			...
			on:blur={deactivate}
		>
			<img src="https://m.media-amazon.com/images/M/MV5BNjRiNmNjMmMtN2U2Yi00ODgxLTk3OTMtMmI1MTI1NjYyZTEzXkEyXkFqcGdeQXVyNjAwNDUxODI@._V1_.jpg" alt="death note" class="film">
			<img src="{Bluray}" alt="Jaquette">
		</div>
	</div>
</div>
